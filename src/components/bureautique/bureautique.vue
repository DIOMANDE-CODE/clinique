            ...
            <router-link to="/admin/specialite"
              ><div class="dash-widget">
                ...
                <div class="dash-widget-info text-right">
                  <span class="widget-title4">Services</span>
                </div>
              </div></router-link
            >
          </div>
          <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
            <router-link to="/admin/departement"
              ><div class="dash-widget">
                ...
                ></span>
                <div class="dash-widget-info text-right">
                  <span class="widget-title3">Departements</span>
                </div>
              </div></router-link
            >
          </div>
          ...
          <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
            <router-link to="/admin/assurance"
              ><div class="dash-widget">
                ...
                <div class="dash-widget-info text-right">
                  <span class="widget-title3">Assurances</span>
                </div>
              </div></router-link
            >
          </div>
          ...
          <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
            <router-link to="/admin/employe"
              ><div class="dash-widget">
                ...
                ></span>
                <div class="dash-widget-info text-right">
                  <span class="widget-title4"> Employés </span>
                </div>
              </div></router-link
            >
          </div>
