          ...
          <ul>
            ...
            <li>
              <router-link to="/admin/clinique"
                ><a
                  ><i class="fa fa-user-md"></i> <span>Medecins</span></a
                ></router-link
              >
            </li>
            <li class="submenu">
              <router-link to="/employe"
                ><a
                  ><i class="fa fa-user"></i> <span> Employés </span></a
                ></router-link
              >
            ...
            <li>
              <router-link to="/poste"
                ><a
                  ><i class="fa fa-hospital-o"></i> <span>Postes</span></a
                ></router-link
              >
            </li>
            <li>
              <a href="appointments.html"
                ><i class="fa fa-calendar"></i> <span>Rendez-vous</span></a
              >
            </li>
            <li>
              <a href="schedule.html"
                ><i class="fa fa-calendar-check-o"></i>
                <span>Plan des medecins</span></a
              >
            </li>
            <li>
              <a href="departments.html"
                ><i class="fa fa-hospital-o"></i> <span>Departements</span></a
              >
            </li>
            <li class="submenu">
              <a href="#"
                ><i class="fa fa-money"></i> <span> Comptes </span>
